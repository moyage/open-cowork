...
3. `.governance/changes/v0.2.9-review-archive-gate-closure/contract.yaml`：执行边界。
4. `.governance/changes/v0.2.9-review-archive-gate-closure/bindings.yaml`：owner 和角色绑定。
